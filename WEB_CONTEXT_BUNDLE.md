...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.14-kirby-problem-1.14-d6825a64-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.14"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.14-kirby-problem-1.14-d6825a64-v1",
      "problem_contract_sha256": "b4930772a23987903ca8a38d2dca54d02fbbe613ea2e836c7696026ac30f5a98",
      "problem_id": "problem:um-kp-1.14-kirby-problem-1.14-d6825a64",
      "route_id": "route:um-kp-1.14-kirby-problem-1.14-d6825a64-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.14-kirby-problem-1.14-d6825a64-source-fidelity-01",
      "graph_id": "graph:um-kp-1.14-kirby-problem-1.14-d6825a64-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.14-kirby-problem-1.14-d6825a64-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.14-kirby-problem-1.14-d6825a64-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For which nonzero $r \\in \\mathbb{Q}$ is it true that for every nontrivial knot $K \\subset S^{3}$ there is a homomorphism $$ \\pi_{1}(S^{3}_{r}(K)) \\to \\operatorname{SU}(2) $$ with nonabelian image?"
          },
          "statement_sha256": "9d713db93b996bae3390508b21a1c72895d4235f7bc208dcfc625a6591756cc0"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.14-kirby-problem-1.14-d6825a64-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.14-kirby-problem-1.14-d6825a64-root",
      "route_id": "route:um-kp-1.14-kirby-problem-1.14-d6825a64-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.14-752d9dec8260",
        "url": "https://www.unsolvedmath.com/problems/KP-1.14"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
